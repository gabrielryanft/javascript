...
function sudoMouse_position() {
    imgs.forEach((img, index) => {
        img.addEventListener("mousemove", (event) => {
            ...
            if(index==3){
                document.documentElement.style.setProperty("--min_wh", "40vmin")
                document.documentElement.style.setProperty("--max_wh", "50vmin")
        ...
        img.addEventListener("mouseout", () => {
            setTimeout(() => {
                if(index==3){
                    document.documentElement.style.setProperty("--min_wh", "0")
                    document.documentElement.style.setProperty("--max_wh", "0")
