...
function canvas_things() {
    ...
    list_cntxt[0].fillRect(50 + ((head_w / 2) - (neck_w / 2)), 35 + head_h, neck_w, neck_h)
    list_cntxt[0].fillRect(50 + ((head_w / 2) - (belly_w / 2)), 35 + head_h + neck_h, belly_w, belly_h)
    list_cntxt[0].fillRect(50 + ((head_w / 2) - (belly_w / 2)), 35 + head_h + neck_h + belly_h, leg_w, leg_h)
    list_cntxt[0].fillRect(50 + ((head_w / 2) - (belly_w / 2)) + belly_w - leg_w, 35 + head_h + neck_h + belly_h, leg_w, leg_h)
    list_cntxt[0].fillRect(50 + ((head_w / 2) - (belly_w / 2)) - arm_w - 2, 35 + head_h + neck_h, arm_w, arm_h)
    list_cntxt[0].fillRect(50 + ((head_w / 2) - (belly_w / 2)) + belly_w + 2, 35 + head_h + neck_h, arm_w, arm_h)
    ...
    list_cntxt[1].arc(30 + pacman_radian, 40 + pacman_radian, pacman_radian, ((Math.PI / 180) * angle_mouth), ((Math.PI / 180) * (360 - angle_mouth)), false)
    ...
    list_cntxt[1].arc(30 + (pacman_radian * 2) + balls_spacing, 40 + pacman_radian, little_balls_rad, 0, Math.PI * 2)
    list_cntxt[1].fill()
    list_cntxt[1].closePath()

    list_cntxt[1].beginPath()
    list_cntxt[1].fillStyle = "blue"
    list_cntxt[1].arc(30 + (pacman_radian * 2) + (balls_spacing * 2 + pacman_radian), 40 + pacman_radian, little_balls_rad, 0, Math.PI * 2)
    list_cntxt[1].fill()
    list_cntxt[1].closePath()

    list_cntxt[1].beginPath()
    list_cntxt[1].fillStyle = "blue"
    list_cntxt[1].arc(30 + (pacman_radian * 2) + (balls_spacing * 3 + pacman_radian * 2), 40 + pacman_radian, little_balls_rad, 0, Math.PI * 2)
    list_cntxt[1].fill()
    list_cntxt[1].closePath()
        ...
        for (let i = 0; i < array_balls_cp.length; i++) {
            ...
            for(let j = 0; j < array_balls_cp.length; j++){
                ...
                if (hypotenuse<101){
                    ...
                    list_cntxt[13].moveTo(array_balls_cp[j].x, array_balls_cp[j].y)
                    list_cntxt[13].lineTo(array_balls_cp[i].x, array_balls_cp[i].y)
